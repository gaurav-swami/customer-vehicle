...
public class Display {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (rs.next()) {
                System.out.printf("%-5d %-20s %-50s %-30s %-25s%n", rs.getInt("customerId"), rs.getString("name"),
            ...
            while (rs.next()) {
                System.out.printf("%-5d %-10s %-10d %-15s %-15s %-5d%n", rs.getInt("VID"), rs.getString("V_NO"),
                        rs.getInt("customerId"), rs.getString("make"), rs.getString("model"), rs.getInt("year"));
            }
            System.out.println();
            ...
            while (rs.next()) {
                System.out.printf("%-5d %-20s %-40s %-5d%n", rs.getInt("serviceId"), rs.getString("serviceName"),
            ...
            while (rs.next()) {
                System.out.printf("%-5d %-20s %-15s%n", rs.getInt("mechanicId"), rs.getString("name"),
                        rs.getString("phone"));
            }
            System.out.println();
            ...
            System.out.printf("%-5s %-5s %-5s %-5s %-15s %-15s %-10s %-15s%n", "BID", "VID", "SvcID", "MechID",
                    "Service Date", "Status", "Cost", "Payment Status");
            while (rs.next()) {
                System.out.printf("%-5d %-5d %-5d %-5d %-15s %-15s %-10d %-15s%n", rs.getInt("BID"), rs.getInt("VID"),
                        rs.getInt("serviceId"), rs.getInt("mechanicId"), rs.getDate("SERVICE_DATE"),
                        rs.getString("STATUS"), rs.getInt("TOTAL_COST"), rs.getString("PAYMENT_STATUS"));
            }
            System.out.println();
            ...
            while (rs.next()) {
                System.out.printf("%-5d %-5d %-40s %-10d%n", rs.getInt("HID"), rs.getInt("BID"),
                        rs.getString("WORK_DESCRIPTION"), rs.getInt("WORK_COST"));
            }
            System.out.println();
