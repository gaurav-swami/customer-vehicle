...
public class AddBooking{
    ...
    public static void main(String args[]) {
        ...
        try {
          ...
          pstmt = conn.prepareStatement("insert into service_booking(bid,vid,serviceId,mechanicId,service_date,status,total_cost,payment_status) values (?,?,?,?,date(),'Pending',?,?);");
